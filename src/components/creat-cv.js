...
<html>
    <head>
        ...
        <link rel="stylesheet" href="Home/css/unicons.css">
        <link rel="stylesheet" href="create-cv/css/main.css">
        ...
        <!-- custom js -->
        <script src = "create-cv/js/script.js"></script>
        <!-- app js -->
        <script src="create-cv/js/app.js"></script>
  ...
  import './create-cv/css/main.css'
    ...
    <div>
        ...
        <nav class="navbar navbar-expand-sm navbar-light">
            <div class="container">
                <a class="navbar-brand" href=""><i class='uil uil-user'></i> HRBOTIX</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item">
                          <a href="/search" class="nav-link" ><span data-hover="Jops">Find Jop</span></a>
                        </li>
                        <li class="nav-item">
                          <a href="" class="nav-link" id="acctive"><span data-hover="CVs">Create CV</span></a>
                        </li>
                        <li class="nav-item">
                            <a href="/cvreview" class="nav-link"><span data-hover="Review">CV Review</span></a>
                        </li>
                        <li class="nav-item">
                            <a href="online-meeting.html" class="nav-link"><span data-hover="Meeting">Online Meeting</span></a>
                        </li>
                    </ul>
    ...
    <section class="movve">
        <h1>Tailored, professional CV creation services</h1>
        <div class="main-text1">Expertly craft resumes for career success with personalized professional guidance
        </div>
        <div class="buttt">
        <a class="button-like" href="#about-sc">Create CV</a>
        <a class="button-like" href="templatechose.html">Chose Template design</a>
        </div>
                            ...
                            <div class = "cv-form-row cv-form-row-about">
                                ...
                                <div class="cols-3">
                                    <div class="form-elem">
                                        ...
                                        <input name="image" type="file" class="form-control image" id="" accept="image/*" onchange="previewImage(this)"/>
                                    </div>
                                    <div class = "form-elem">
                    ...
                    <div class = "preview-cnt-l bg-green text-white">
                        <div class = "preview-blk">
                            <div class="preview-image">
                                <img id="preview" src="profile_pic.jpg"/>
                            </div>
